...
\section{Задание}
Требуется разработать на языке Java:
\begin{itemize}
    \item Параметризованная типовым параметром T последовательность контейнеров, классы которых реализуют интерфейс Iterable (итератор – «конкатенация» итераторов контейнеров). 
    \item Последовательность целых чисел с итератором по цифрам десятичного представления чисел. 
...
\section{Результаты}
В результате лабораторной работы был создан параметризированный класс с операцией конкатенации циклов, и класс для итерации списка чисел по его цифрам
...
\begin{center}
    ...
    \includegraphics[width=0.85\textwidth]{lab4_2}
    \captionsetup{justification=centering}
    \captionof{figure}{Результат работы Test1.java}
\end{center}
